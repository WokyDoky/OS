...
* **Assignment 2: Core Networking in C**
    * **Description:** This assignment covers networking aspects with TCP/IP and UDP/IP in the POSIX world, as expressed in C.
    * **Explore the project:** You can find the source code, Makefile, and a detailed README in the **[Assignment 2 Folder](https://github.com/WokyDoky/OS/tree/main/A2)**.